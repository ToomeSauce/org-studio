...
export function TopBar() {
  ...
  return (
    <>
      <header className="h-14 border-b border-[var(--border-default)] bg-[var(--bg-primary)] flex items-center justify-between px-6 gap-4 shrink-0 z-30">
        {/* Left — search */}
        <div className="flex items-center gap-3 flex-1 max-w-md">
          <div className="relative flex-1">
            ...
            <input
              ...
              placeholder="Search..."
              className="w-full pl-9 pr-3 py-2 text-[var(--text-base)] bg-[var(--bg-secondary)] border border-[var(--border-default)] rounded-[var(--radius-md)] text-[var(--text-primary)] placeholder-[var(--text-muted)] outline-none focus:border-[var(--accent-primary)] transition-colors"
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className={clsx(
              'flex items-center gap-2 px-4 py-2 text-[var(--text-sm)] font-semibold rounded-[var(--radius-md)] transition-all',
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-[var(--text-xs)] text-[var(--text-muted)]">{state === 'connected' ? 'Connected' : 'Offline'}</span>
          </div>
        </div>
      </header>
          ...
          >
            <div className="flex items-center justify-between px-5 py-4 border-b border-[var(--border-default)]">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-[var(--text-md)] font-semibold">Ping Henry</h2>
              </div>
            ...
            <div className="flex-1 p-5 flex items-center justify-center text-[var(--text-base)] text-[var(--text-muted)]">
