...
/**
 * TeamPerformanceSection — delivery metrics folded into /team (#1651).
 *
 * Formerly the /performance page. Keepers: Weekly Digest, team summary,
 * agent metric cards + drill-down trends + coaching insights, Quality
 * Scorecard, Agent Comparison. Dropped: Cultural Alignment (subjective,
 * Kudos covers recognition), Team Health charts (overlapped agent cards),
 * Version Velocity (project-scoped, duplicates roadmap progress).
 * Cost Analytics → /usage, Skill Freshness → /system.
 */
...
export default function TeamPerformanceSection() {
  ...
  return (
    <div className="space-y-8">
      {/* Section filter (only when non-trivial sections exist) */}
