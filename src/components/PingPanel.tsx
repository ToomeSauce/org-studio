              ...
              {agents.map((agent) => {
                ...
                return (
                  <button
                    ...
                    style={
                      isSelected
                        ? { background: color.glowRgba, color: '#fff', border: `1px solid ${color.border}`, boxShadow: `0 0 12px ${color.glowRgba}` }
                        : { background: color.bgRgba, border: `1px solid transparent` }
                    }
                  >
